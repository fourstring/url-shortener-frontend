...
export function useEntities<T extends IEntity, InputT = T, R = T>(service: BaseService<T, InputT, R>, filterOption?: IRequestFilterOptions<T>): EntitiesResult<T, InputT> {
